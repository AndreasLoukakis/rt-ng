...
@Component({
  ...
  templateUrl: './movie-collection-state.component.html',
  styleUrls: ['./movie-collection-state.component.scss']
})
export class MovieCollectionStateComponent implements OnInit {
